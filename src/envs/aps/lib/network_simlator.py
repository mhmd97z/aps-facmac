import torch
from envs.aps.lib.channel_manager import NlosChannelManager
from envs.aps.lib.utils import set_random_seed
...
class NetworkSimulator:
    def __init__(self, conf):
        ...
        if self.scenario_conf['precoding_algorithm'] == "olp":
            from envs.aps.lib.power_control import OlpGnnPowerControl
            self.power_control = OlpGnnPowerControl(self.scenario_conf)
        elif self.scenario_conf['precoding_algorithm'] == "mrt":
            from envs.aps.lib.power_control import MrtPowerControl
